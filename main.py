...
class InstagramBot:
    def __init__(self, username, password):
        ...
        #Aqui fica o driver geckodriver Link para download (https://github.com/mozilla/geckodriver/releases/tag/v0.30.0)
        self.driver = webdriver.Firefox(executable_path=r'C:\Users\gabriel.santos\Desktop\geckodriver\geckodriver.exe')


    #Realiza o login no instagram, digitar senha, username e entrar
    def login(self):
        driver = self.driver
        ...
        for pic_href in pic_hrefs:
            ...
            try:
                driver.find_element_by_xpath(
                    '//button[@class="QBdPU rrUvL"]').click()
